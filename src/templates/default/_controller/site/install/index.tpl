<html>
	...
	<body>
		<div id="wrapper">
			...
			<div id="footer">
				Copyright 2012 &copy; <a href="https://github.com/voduytuan/litpi-framework" title="Go to litpi Github page" target="_blank">https://github.com/voduytuan/litpi-framework</a>. All rights reserved.
			</div>
		</div><!-- end #wrapper -->
	</body>
</html>