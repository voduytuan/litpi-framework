<div class="avatar">
    <img src="{$imageDir}site/sample/avatar.png" alt="Avatar">
</div>

<div class="content">
    <h1 class="title">Geeky<br>Litpiman</h1>
    ...
    <p>
        ...
        <br /><a id="installbutton" href="{$conf.rooturl}site/install">START \Controller\Index\Install &raquo;</a>
    </p>
    ...
    <p>
        ...
        <a href="http://www.github.com/voduytuan/litpi-framework">View on Github</a>
    </p>
