...
<html>
	...
	<body class='login_body'>
		...
		<a title="Go to main site" href="{$conf.rooturl}" target="_blank" class="pull-right"><i class="fa fa-home"></i></a>
			<h2>{$lang.controller.title}</h2>
			<h4>Please Input email of your account information to continue</h4>

			<form action="{$conf.rooturl_admin}forgotpass?redirect={$redirectUrlEncode}" method="post" class="validate form-horizontal" style="padding-top:20px;">
				...
				<div class="submit">
					...
					<input type="submit" name="fsubmit" class="btn btn-success pull-right" value="{$lang.controller.submitLabel}" />
				</div>
